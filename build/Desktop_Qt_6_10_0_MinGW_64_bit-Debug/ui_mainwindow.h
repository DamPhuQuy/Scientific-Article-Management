...
"}"));
        ...
        label_ProjectName->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        ...
        label_Teacher->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
